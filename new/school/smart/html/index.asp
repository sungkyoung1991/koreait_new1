...
Function getMainBanner_smart(ByVal Set_type)
	...
	sql = "select take_idx, pj_code, order_no, content, file2, c_dt from renew_banner where pj_code='융합스마트' order by order_no asc , take_idx desc"
...
Function getSmart_eventArr(ByVal Set_type)
	...
	sql = "TBL_SiteBoard_L @gubun='L', @bs_gubun='classlife,itgallery,prointerview,itstar,pressboard', @bbscode='융합스마트', @topCnt=4, @pageNumber=1, @RowPerPage = 4"
	...
	<div id="mainVisual">
		...
		%>
            ...
            <li class="swiper-slide new">
	                ...
	                <img onClick="gop('<%=mbanner_smart(i).item("content")%>');" style="cursor:pointer; width:100%; height:552px; max-height:522px;" src="/upload_files/renew/banner/<%=mbanner_smart(i).item("file2")%>">
...
<!--		<div class="mainQuick">
    ...
    <div id="mainContents">
    	<div class="mainContentsImg">
            ...
            <img class="lazy" data-src="../images/2019/main/part_2_2020.jpg">

        </div>
	</div>
	<div class="introduce08">
		<h2><span>NEWS & EVENT</span>소식 및 행사</h2>
		<a href="http://www.koreait.ac.kr/new/school/smart/html/board_index.asp" class="mainFocusMore">더보기</a>
		<ul>
                ...
                <li>
                	<a href="http://www.koreait.ac.kr/new/school/smart/html/board_index.asp?page=1&take_idx=<%=smart_event(i).item("take_idx")%>">
