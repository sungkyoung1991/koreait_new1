	...
	<header id="header" class="header">
		<div class="gnbWrap">
			<div class="auto">
                ...
                <img class="lazy" data-src="../images/layout/logo.jpg" alt="한국IT직업전문학교 융합스마트계열">
                <span class="hidden">한국IT직업전문학교 융합스마트계열</span></a></h1>
				<nav id="gnb">
					<ul class="gnbList">
						<li style="display:none;">
							<h2><a href="introduce.asp" style="display:none;">융합스마트계열 소개</a></h2>
							<ul class="sub">
								<li>
									<h3><a href="introduce.asp">융합스마트계열 소개</a></h3>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul class="sub">
								<li><h3><a href="lecture02.asp">컴퓨터공학</a></h3></li>
                                <li><h3><a href="lecture04.asp">소프트웨어공학</a></h3></li>
                                <li><h3><a href="lecture01.asp">드론·로봇</a></h3></li>
                                <li><h3><a href="lecture07.asp">AI영상처리</a></h3></li>


                                <li><h3><a href="lecture06.asp">AI언어처리</a></h3></li>
