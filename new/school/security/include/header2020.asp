...
<head>
	...
	<meta property="og:url" content="http://www.koreait.ac.kr/new/school/security/html/index.asp">
	<meta name="description" content="정보보안학과, 정보보호학과, 특성화 IT전문학교, 포렌식,관제센터 최첨단 시설, 기업형 프로젝트 도입">
	<meta name="og:description" content="정보보안학과, 정보보호학과, 특성화 IT전문학교, 포렌식,관제센터 최첨단 시설, 기업형 프로젝트 도입">
	<meta name="Title" content="<%=GetFileName%>">
	<meta name="og:title" content="<%=GetFileName%>">
	<meta name="keywords" content="정보보안학과, 정보보호학과, 사이버보안학과, 컴퓨터보안학과">
	...
	<header id="header" class="header new2020">
		<div class="gnbWrap">
			<div class="auto">
                ...
                <img class="lazy" data-src="../images/layout/school_security_logo2020.png" alt="한국IT직업전문학교 정보보안계열">
                <span class="hidden">한국IT직업전문학교 정보보안계열</span></a></h1>
				<nav id="gnb">
					<ul class="gnbList">
						<li style="display:none;">
							<h2><a href="../html/introduce.asp">정보보안계열 소개</a></h2>
							<ul class="sub">
								<li>
									<h3><a href="../html/introduce.asp">정보보안계열 소개</a></h3>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul class="sub">
								<!--<li><h3><a href="lecture01.asp">융합보안(3년제)</a></h3></li>
								<li><h3><a href="lecture02.asp">컴퓨터보안</a></h3></li>
								<li><h3><a href="lecture03.asp">해킹바이러스</a></h3></li>
								<li><h3><a href="lecture04.asp">디지털포렌식(디지털수사)</a></h3></li>-->

                	<li><h3><a href="lecture02.asp">정보보안</a></h3></li>
                  <li><h3><a href="lecture03.asp">사이버해킹보안</a></h3></li>
                  <li><h3><a href="lecture04.asp">디지털포렌식(사이버경찰)</a></h3></li>
                <li><h3><a href="lecture01.asp">융합보안(인공지능)</a></h3></li>
