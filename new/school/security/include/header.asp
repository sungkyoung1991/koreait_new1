	...
	<header id="header" class="header">
		<div class="gnbWrap">
			<div class="auto">
                ...
                <img class="lazy" data-src="../images/layout/logo.jpg" alt="한국IT직업전문학교 정보보안계열">
					...
					<ul class="gnbList">
						...
						<li>
							...
							<ul class="sub">
                                ...
                                <li><h3><a href="lecture01.asp">융합보안(인공지능/IoT)</a></h3></li>
								<li><h3><a href="lecture02.asp">정보보안</a></h3></li>
								<li><h3><a href="lecture03.asp">해킹</a></h3></li>
								<li><h3><a href="lecture04.asp">디지털포렌식(사이버수사)</a></h3></li>
