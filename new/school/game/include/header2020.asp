...
<head>
	...
	<meta name="description" content="게임학과, 게임프로그래밍학과 등, 블리자드, 넥슨 등 취업, 학사학위 취득, G-STAR 13년 연속출품">
	<meta name="og:description" content="게임학과, 게임프로그래밍학과 등, 블리자드, 넥슨 등 취업, 학사학위 취득, G-STAR 13년 연속출품">
	<meta name="Title" content="<%=GetFileName%>">
	<meta name="og:title" content="<%=GetFileName%>">
	<meta name="keywords" content="게임학과, 게임기획학과, 게임그래픽학과, 게임프로그래밍학과, 게임공학과, 게임관련학과">
	...
	<header id="header" class="header new2020">
		<div class="gnbWrap">
			<div class="auto">
                ...
                <img class="lazy" data-src="../images/layout/school_game_logo2020.png" alt="한국IT직업전문학교 게임계열">
                <span class="hidden">한국IT직업전문학교 게임계열</span></a></h1>
				<nav id="gnb">
					<ul class="gnbList">
						<li style="display:none;">
							<h2><a href="../html/introduce.asp">게임계열 소개</a></h2>
							<ul class="sub">
								<li>
									<h3><a href="../html/introduce.asp">게임계열 소개</a></h3>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul class="sub">
								<li><h3><a href="lecture01.asp">게임기획</a></h3></li>
								<li><h3><a href="lecture02.asp">게임인공지능프로그래밍</a></h3></li>
								<li><h3><a href="lecture03.asp">게임아트디자인</a></h3></li>
							</ul>
						</li>
						<li>
